...
/* ---------- Component ---------- */
const MonthlyView = ({ academicYear, semester, section }) => {
  ...
  return (
    <div className="border rounded p-4 mb-6">
      <h2 className="text-xl font-semibold mb-1">Monthly Timetable</h2>
      ...
      {month && week && day && (
        <div className="border rounded">
          {timetableTemplate[day].map((item, index) => (
            <div
              key={index}
